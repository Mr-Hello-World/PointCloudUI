 ...
 * @see writeVertex
 */
void DL_Dxf::writePolylineSZW(DL_WriterA& dw,
                           const SZW_PolylineData& data,
                           const DL_Attributes& attrib) {

							   dw.entity("POLYLINE");
							   dw.dxfString(8,attrib.getLayer());
							   dw.dxfInt(62,attrib.getColor());
							   dw.dxfString(6,attrib.getLineType());
							   dw.dxfInt(70,data.flags);
							   dw.dxfString(66,"1");
							   dw.dxfString(10,"0.0");
							   dw.dxfString(20,"0.0");
							   ...
							   {
								   dw.dxfString(0, "VERTEX");
								   dw.dxfString(8,attrib.getLayer());
								   dw.dxfReal(10,data.vertex[i].x);
								   dw.dxfReal(20,data.vertex[i].y);
								   dw.dxfReal(30,data.vertex[i].z);

								 
							   }
							   dw.dxfString(0,"SEQEND");
							   dw.dxfString(8,"0");
  ...
  //      dw.dxfString(100, "AcDbEntity");
  //      dw.dxfString(100, "AcDbPolyline");
  //      dw.dxfInt(90, (int)data.vertex.size());
  //      dw.dxfInt(70, data.flags);
		////cout<<"hheszw";
		//for (int i=0;i<data.vertex.size();++i)
		//{
		//	dw.dxfString(0, "VERTEX");
		//	dw.coord(DL_VERTEX_COORD_CODE, data.vertex[i].x, data.vertex[i].y,data.vertex[i].z);
		//}
  //  } else {
  //      dw.entity("POLYLINE");
  //      dw.entityAttributes(attrib);
